...
Route::get('login/usp', [LoginUspController::class, 'redirectToProvider'])->name('login.usp');
...
# Login empresa
Route::get('login/empresa', [LoginEmpresaController::class, 'create'])->name('login.empresa');
